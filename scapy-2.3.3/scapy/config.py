...
class CacheInstance(dict):
    ...
    def iteritems(self):
        ...
        t0 = time.time()
        return ((k, v) for (k, v) in dict.iteritems(self)
    ...
    def iterkeys(self):
        ...
        t0 = time.time()
        return (k for k in dict.iterkeys(self) if t0 -
    ...
    def itervalues(self):
        ...
        t0 = time.time()
        return (v for (k, v) in dict.iteritems(self)
                if t0 - self._timetable[k] < self.timeout)
    ...
    def keys(self):
        ...
        t0 = time.time()
        return [k for k in dict.iterkeys(
            self) if t0 - self._timetable[k] < self.timeout]

    def values(self):
        if self.timeout is None:
            return dict.values(self)
        t0 = time.time()
        return [v for (k, v) in dict.iteritems(self) if t0 -
                self._timetable[k] < self.timeout]
    ...
    def summary(self):
        return "%s: %i valid items. Timeout=%rs" % (
            self.name, len(self), self.timeout)
