...
def do_graph(graph, prog=None, format=None, target=None,
             type=None, string=None, options=None):
...
class EnumElement:
    ...
    def __repr__(self):
        return "<%s %s[%r]>" % (self.__dict__.get(
            "_name", self.__class__.__name__), self._key, self._value)
...
class RawPcapWriter:
    ...
    def __init__(self, filename, linktype=None, gz=False,
...
def __make_table(yfmtfunc, fmtfunc, endline, list, fxyz,
                 sortx=None, sorty=None, seplinefunc=None):
    vx = {}
    vy = {}
    vz = {}
    vxf = {}
